...
class dataToCSV:
	...
	def init(self,*args):
		...
		# category_info = pd.read_csv("AR_Parents.csv")
		# cat_name      = list(category_info['category_name'])
		# parent_name   = list(category_info['parents_name'])
		# a = "Organic Food"
		# list3 = []
		# for m,n in zip(cat_name,parent_name):
		# 	if a in m:
		# 		list3.append(n)
